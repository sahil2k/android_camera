...
class MainActivity : AppCompatActivity() {
    ...
    private fun takePhoto() {
        ...
        Log.d(TAG, "button is clicked at least lol")
...
//                put(MediaStore.Images.Media.DATA, "Pictures/CameraX-Image")
//            }
//        }
//
...
//            .build()
        ...
        val root: File = applicationContext.cacheDir
        val imageFile = File(root, "$name.jpeg")
        if (!imageFile.exists()) {
            imageFile.mkdirs()
        }
